...
function EditGroupAssignmentSubmission({
  submissionData,
  groupId,
  toggleModal,
}) {
  ...
  const mutation = useMutation(
    (data) =>
      axiosInterceptor.put(`/group-submissions/${submissionData?.id}`, data),
    {
      onSuccess: () => {
        onSubmissionUpdateSuccess();
        queryClient.invalidateQueries(['group-submissions', groupId]);
      },
...
export default EditGroupAssignmentSubmission;
